  ...
  return (
    <View className="px-5 mt-3">
      <View className="flex-row items-center justify-between mb-4">
        <View>
          <Text className="text-gray-900 text-xl font-bold">Recent Blog</Text>
      ...
      >
        ...
        <View className="relative">
          ...
          <View className="absolute top-4 left-4 bg-violet-600 px-3 py-1 rounded-full">
            <Text className="text-white text-xs font-semibold">Design</Text>
          </View>
        </View>
        ...
        <View className="p-5">
          ...
          <Text className="text-gray-500 text-sm leading-5 mt-2">
            Clean spacing, typography and layout create modern mobile app
          ...
          <View className="flex-row items-center justify-between mt-6">
            <View className="flex-row items-center">
              ...
              <View className="ml-2">
                ...
                <Text className="text-gray-400 text-[11px]">Just now</Text>
              </View>
            </View>
